...
function moveDefender(player){
    ...
    if(lineFuture ==='Defender' ){
        ...
        if(player.team===1){
            ...
            const randomIndex = Math.floor(Math.random()*defendersFiltred.length)
            receptorPlayer = defendersFiltred[randomIndex];;
          }else{
...
function moveMieldfilder(player,team){
    ...
    if(lineFuture ==='Midfielder'){
        ...
        if(player.team===1){
            ...
            const randomIndex = [Math.floor(Math.random()*midfielderFiltred.length)];
            receptorPlayer = midfielderFiltred[randomIndex];
          }else{
